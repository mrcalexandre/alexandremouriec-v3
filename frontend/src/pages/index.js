        ...
        <div className="w-full">
          <div>
            <img
              ...
              alt="Photo"
            />
            <h2 className="text-3xl text-center tracking-tight leading-10 font-extrabold text-gray-900 sm:text-2xl sm:leading-none md:text-3xl mt-6">
              Looking for a Full-Stack/Frontend role in London 🇬🇧
            </h2>
            <div className="flex flex-row mt-2 items-center">
              <a
                href="https://github.com/remi2j"
                title="GitHub"
                target="_blank"
                rel="noopener noreferrer"
                class="shadow-sm hover:shadow bg-white text-gray-900 mr-2 py-2 px-3 rounded-full"
              >
                <svg
                  stroke="currentColor"
                  fill="none"
